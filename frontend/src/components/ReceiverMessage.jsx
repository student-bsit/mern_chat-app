...
const ReceiverMessage = ({ image, message }) => {
    ...
    return (
        <div className='flex items-start gap-[10px]'>
            ...
            <div ref={scroll} className='w-fit max-w-[500px] px-[20px] py-[10px] bg-[rgb(23,151,194)] text-white text-[19px] rounded-tl-none rounded-2xl relative left-0  shadow-gray-400 shadow-lg flex flex-col gap-[10px]' >
